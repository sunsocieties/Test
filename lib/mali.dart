...
class MaliPage extends StatefulWidget {
  const MaliPage({super.key});

  @override
  MaliPageState createState() => MaliPageState();
}

class MaliPageState extends State<MaliPage> {
