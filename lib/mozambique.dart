...
class MozambiquePage extends StatefulWidget {
  const MozambiquePage({super.key});

  @override
  MozambiquePageState createState() => MozambiquePageState();
}

class MozambiquePageState extends State<MozambiquePage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Mozambique')) {
                        return GestureDetector(
                          onTap: () async {
