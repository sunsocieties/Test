...
class NamibiaPage extends StatefulWidget {
  const NamibiaPage({super.key});

  @override
  NamibiaPageState createState() => NamibiaPageState();
}

class NamibiaPageState extends State<NamibiaPage> {
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: isSubscribed ? Colors.white : Colors.black,
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize:
                            15, // Ajustez la taille du texte pour l'esthétique
                      ),
                    ),
                  ],
                ),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Namibia')) {
                        return GestureDetector(
                          onTap: () async {
