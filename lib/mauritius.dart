...
class MauritiusPage extends StatefulWidget {
  const MauritiusPage({super.key});

  @override
  MauritiusPageState createState() => MauritiusPageState();
}

class MauritiusPageState extends State<MauritiusPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Mauritius')) {
                        return GestureDetector(
                          onTap: () async {
