...
class SouthsPage extends StatefulWidget {
  const SouthsPage({super.key});

  @override
  SouthsPageState createState() => SouthsPageState();
}

class SouthsPageState extends State<SouthsPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('South Sudan')) {
                        return GestureDetector(
                          onTap: () async {
