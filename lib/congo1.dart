...
class BrazzavillePage extends StatefulWidget {
  const BrazzavillePage({super.key});

  @override
  BrazzavillePageState createState() => BrazzavillePageState();
}

class BrazzavillePageState extends State<BrazzavillePage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Brazzaville')) {
                        return GestureDetector(
                          onTap: () async {
