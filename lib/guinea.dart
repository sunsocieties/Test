...
class GuineaPage extends StatefulWidget {
  const GuineaPage({super.key});

  @override
  GuineaPageState createState() => GuineaPageState();
}

class GuineaPageState extends State<GuineaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Guinea')) {
                        return GestureDetector(
                          onTap: () async {
