...
class AngolaPage extends StatefulWidget {
  const AngolaPage({super.key});

  @override
  AngolaPageState createState() => AngolaPageState();
}

class AngolaPageState extends State<AngolaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Angola')) {
                        return GestureDetector(
                          onTap: () async {
