...
class TunisiaPage extends StatefulWidget {
  const TunisiaPage({super.key});

  @override
  TunisiaPageState createState() => TunisiaPageState();
}

class TunisiaPageState extends State<TunisiaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Tunisia')) {
                        return GestureDetector(
                          onTap: () async {
