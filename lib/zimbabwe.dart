...
class ZimbabwePage extends StatefulWidget {
  const ZimbabwePage({super.key});

  @override
  ZimbabwePageState createState() => ZimbabwePageState();
}

class ZimbabwePageState extends State<ZimbabwePage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Zimbabwe')) {
                        return GestureDetector(
                          onTap: () async {
