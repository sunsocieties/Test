...
class NigerPage extends StatefulWidget {
  const NigerPage({super.key});

  @override
  NigerPageState createState() => NigerPageState();
}

class NigerPageState extends State<NigerPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Niger')) {
                        return GestureDetector(
                          onTap: () async {
