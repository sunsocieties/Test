...
class GabonPage extends StatefulWidget {
  const GabonPage({super.key});

  @override
  GabonPageState createState() => GabonPageState();
}

class GabonPageState extends State<GabonPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Gabon')) {
                        return GestureDetector(
                          onTap: () async {
