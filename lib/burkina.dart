...
class BurkinaPage extends StatefulWidget {
  const BurkinaPage({super.key});

  @override
  BurkinaPageState createState() => BurkinaPageState();
}

class BurkinaPageState extends State<BurkinaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Burkina Faso')) {
                        return GestureDetector(
                          onTap: () async {
