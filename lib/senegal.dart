...
class SenegalPage extends StatefulWidget {
  const SenegalPage({super.key});

  @override
  SenegalPageState createState() => SenegalPageState();
}

class SenegalPageState extends State<SenegalPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Senegal')) {
                        return GestureDetector(
                          onTap: () async {
