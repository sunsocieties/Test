...
class SierraleonePage extends StatefulWidget {
  const SierraleonePage({super.key});

  @override
  SierraleonePageState createState() => SierraleonePageState();
}

class SierraleonePageState extends State<SierraleonePage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Sierra Leone')) {
                        return GestureDetector(
                          onTap: () async {
