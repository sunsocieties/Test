...
class BeninPage extends StatefulWidget {
  const BeninPage({super.key});

  @override
  BeninPageState createState() => BeninPageState();
}

class BeninPageState extends State<BeninPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Benin')) {
                        return GestureDetector(
                          onTap: () async {
