...
class MauritaniaPage extends StatefulWidget {
  const MauritaniaPage({super.key});

  @override
  MauritaniaPageState createState() => MauritaniaPageState();
}

class MauritaniaPageState extends State<MauritaniaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Mauritania')) {
                        return GestureDetector(
                          onTap: () async {
