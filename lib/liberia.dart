...
class LiberiaPage extends StatefulWidget {
  const LiberiaPage({super.key});

  @override
  LiberiaPageState createState() => LiberiaPageState();
}

class LiberiaPageState extends State<LiberiaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Liberia')) {
                        return GestureDetector(
                          onTap: () async {
