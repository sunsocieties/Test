...
class ZambiaPage extends StatefulWidget {
  const ZambiaPage({super.key});

  @override
  ZambiaPageState createState() => ZambiaPageState();
}

class ZambiaPageState extends State<ZambiaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Zambia')) {
                        return GestureDetector(
                          onTap: () async {
