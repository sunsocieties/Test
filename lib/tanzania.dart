...
class TanzaniaPage extends StatefulWidget {
  const TanzaniaPage({super.key});

  @override
  TanzaniaPageState createState() => TanzaniaPageState();
}

class TanzaniaPageState extends State<TanzaniaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Tanzania')) {
                        return GestureDetector(
                          onTap: () async {
