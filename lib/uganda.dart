...
class UgandaPage extends StatefulWidget {
  const UgandaPage({super.key});

  @override
  UgandaPageState createState() => UgandaPageState();
}

class UgandaPageState extends State<UgandaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Uganda')) {
                        return GestureDetector(
                          onTap: () async {
