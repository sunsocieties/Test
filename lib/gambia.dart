...
class GambiaPage extends StatefulWidget {
  const GambiaPage({super.key});

  @override
  GambiaPageState createState() => GambiaPageState();
}

class GambiaPageState extends State<GambiaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Gambia')) {
                        return GestureDetector(
                          onTap: () async {
