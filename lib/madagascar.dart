...
class MadagascarPage extends StatefulWidget {
  const MadagascarPage({super.key});

  @override
  MadagascarPageState createState() => MadagascarPageState();
}

class MadagascarPageState extends State<MadagascarPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Madagascar')) {
                        return GestureDetector(
                          onTap: () async {
