...
class DjiboutiPage extends StatefulWidget {
  const DjiboutiPage({super.key});

  @override
  DjiboutiPageState createState() => DjiboutiPageState();
}

class DjiboutiPageState extends State<DjiboutiPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Djibouti')) {
                        return GestureDetector(
                          onTap: () async {
