...
class SouthaPage extends StatefulWidget {
  const SouthaPage({super.key});

  @override
  SouthaPageState createState() => SouthaPageState();
}

class SouthaPageState extends State<SouthaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('South Africa')) {
                        return GestureDetector(
                          onTap: () async {
