...
class SudanPage extends StatefulWidget {
  const SudanPage({super.key});

  @override
  SudanPageState createState() => SudanPageState();
}

class SudanPageState extends State<SudanPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Sudan')) {
                        return GestureDetector(
                          onTap: () async {
