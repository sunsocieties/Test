...
class MoroccoPage extends StatefulWidget {
  const MoroccoPage({super.key});

  @override
  MoroccoPageState createState() => MoroccoPageState();
}

class MoroccoPageState extends State<MoroccoPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Morocco')) {
                        return GestureDetector(
                          onTap: () async {
