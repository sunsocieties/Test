...
class BissauPage extends StatefulWidget {
  const BissauPage({super.key});

  @override
  BissauPageState createState() => BissauPageState();
}

class BissauPageState extends State<BissauPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Guinea Bissau')) {
                        return GestureDetector(
                          onTap: () async {
