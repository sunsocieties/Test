...
class EritreaPage extends StatefulWidget {
  const EritreaPage({super.key});

  @override
  EritreaPageState createState() => EritreaPageState();
}

class EritreaPageState extends State<EritreaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Eritrea')) {
                        return GestureDetector(
                          onTap: () async {
