...
class EquatorialPage extends StatefulWidget {
  const EquatorialPage({super.key});

  @override
  EquatorialPageState createState() => EquatorialPageState();
}

class EquatorialPageState extends State<EquatorialPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Equatorial Guinea')) {
                        return GestureDetector(
                          onTap: () async {
