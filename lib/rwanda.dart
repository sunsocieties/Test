...
class RwandaPage extends StatefulWidget {
  const RwandaPage({super.key});

  @override
  RwandaPageState createState() => RwandaPageState();
}

class RwandaPageState extends State<RwandaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Rwanda')) {
                        return GestureDetector(
                          onTap: () async {
