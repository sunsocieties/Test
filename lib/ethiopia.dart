...
class EthiopiaPage extends StatefulWidget {
  const EthiopiaPage({super.key});

  @override
  EthiopiaPageState createState() => EthiopiaPageState();
}

class EthiopiaPageState extends State<EthiopiaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Ethiopia')) {
                        return GestureDetector(
                          onTap: () async {
