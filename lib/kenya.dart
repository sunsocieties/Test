...
class KenyaPage extends StatefulWidget {
  const KenyaPage({super.key});

  @override
  KenyaPageState createState() => KenyaPageState();
}

class KenyaPageState extends State<KenyaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Kenya')) {
                        return GestureDetector(
                          onTap: () async {
