...
class EswatiniPage extends StatefulWidget {
  const EswatiniPage({super.key});

  @override
  EswatiniPageState createState() => EswatiniPageState();
}

class EswatiniPageState extends State<EswatiniPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Eswatini')) {
                        return GestureDetector(
                          onTap: () async {
