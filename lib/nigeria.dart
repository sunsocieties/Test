...
class NigeriaPage extends StatefulWidget {
  const NigeriaPage({super.key});

  @override
  NigeriaPageState createState() => NigeriaPageState();
}

class NigeriaPageState extends State<NigeriaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Nigeria')) {
                        return GestureDetector(
                          onTap: () async {
