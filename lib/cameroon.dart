...
class CameroonPage extends StatefulWidget {
  const CameroonPage({super.key});

  @override
  CameroonPageState createState() => CameroonPageState();
}

class CameroonPageState extends State<CameroonPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Cameroon')) {
                        return GestureDetector(
                          onTap: () async {
