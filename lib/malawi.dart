...
class MalawiPage extends StatefulWidget {
  const MalawiPage({super.key});

  @override
  MalawiPageState createState() => MalawiPageState();
}

class MalawiPageState extends State<MalawiPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Malawi')) {
                        return GestureDetector(
                          onTap: () async {
