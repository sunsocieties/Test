...
class BotswanaPage extends StatefulWidget {
  const BotswanaPage({super.key});

  @override
  BotswanaPageState createState() => BotswanaPageState();
}

class BotswanaPageState extends State<BotswanaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Botswana')) {
                        return GestureDetector(
                          onTap: () async {
