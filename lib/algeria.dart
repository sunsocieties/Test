...
class AlgeriaPage extends StatefulWidget {
  const AlgeriaPage({super.key});

  @override
  AlgeriaPageState createState() => AlgeriaPageState();
}

class AlgeriaPageState extends State<AlgeriaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Algeria')) {
                        return GestureDetector(
                          onTap: () async {
