...
class ComorosPage extends StatefulWidget {
  const ComorosPage({super.key});

  @override
  ComorosPageState createState() => ComorosPageState();
}

class ComorosPageState extends State<ComorosPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Comoros')) {
                        return GestureDetector(
                          onTap: () async {
