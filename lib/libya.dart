...
class LibyaPage extends StatefulWidget {
  const LibyaPage({super.key});

  @override
  LibyaPageState createState() => LibyaPageState();
}

class LibyaPageState extends State<LibyaPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Libya')) {
                        return GestureDetector(
                          onTap: () async {
