...
class IvoirePage extends StatefulWidget {
  const IvoirePage({super.key});

  @override
  IvoirePageState createState() => IvoirePageState();
}

class IvoirePageState extends State<IvoirePage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Ivoire')) {
                        return GestureDetector(
                          onTap: () async {
