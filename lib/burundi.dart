...
class BurundiPage extends StatefulWidget {
  const BurundiPage({super.key});

  @override
  BurundiPageState createState() => BurundiPageState();
}

class BurundiPageState extends State<BurundiPage> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (article.tags.contains('Burundi')) {
                        return GestureDetector(
                          onTap: () async {
